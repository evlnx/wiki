...
* [x] Estilizar admoniciones (notas, advertencias, atención, importantes) en CSS personalizado.

Pendientes
==========
* [ ] Crear una plantilla estándar y homogénea para la redacción de nuevos HowTo.
* [ ] Configurar webhook/CI para despliegue automatizado del árbol wiki hacia el servicio Gollum.
* [ ] Evaluar e integrar sistema ligero y soberano de comentarios o retroalimentación en páginas seleccionadas.
