...
# crear configuración /include.d/zendframework.conf
cat << 'EOF' > /etc/nginx/include.d/zendframework.conf
index index.php;
...
cat << 'EOF' > /etc/nginx/server.d/server.name.conf
server {
    listen       80;
    ...
    root         /usr/share/bareos-webui/public;
     ...
     include include.d/zendframework.conf;
}
